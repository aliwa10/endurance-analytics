...
def test_build_running_summary():
    ...
    assert test_summary["timer_time"] == pytest.approx(80.35130000000001)
...
def test_build_cycling_summary_power():
    ...
    assert test_summary["timer_time"] == pytest.approx(187.6223)
...
def test_build_cycling_summary_nopower():
    ...
    assert test_summary["timer_time"] == pytest.approx(133.04516666666666)
...
def test_build_swimming_summary():
    ...
    assert test_summary["timer_time"] == pytest.approx(67.63146666666667)
